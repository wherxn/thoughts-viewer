...
const { parseCookies, getUserInfoByCode, isUserAllowed, setSessionCookie } = require('../_utils');
...
module.exports = async (req, res) => {
  try {
    ...
    // 5. 设置登录 cookie
    setSessionCookie(res, userInfo.open_id);

    // 6. 清除 oauth_state cookie
    res.setHeader(
      'Set-Cookie',
      `oauth_state=; Path=/; HttpOnly; Secure; SameSite=Lax; Expires=Thu, 01 Jan 1970 00:00:00 GMT`
    );
